...
// since it extends the View.class, we get the onDraw method, (the View gets re- and redrawn very fast all the time, always calling the onDraw().) which makes an Canvas Object available, which we can use to draw on.
