...
Copy aws-api-gateway-sdk-1.0.0.jar from the `target` folder and all other libraries located in `target/lib` to your project's lib folder.
...
// Invoke your usersDelete method
Empty  output = client.usersDelete(username);
